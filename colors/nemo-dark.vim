" nemo-dark, a vim colourscheme by nightsense
"
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#9fa7bf'
  let g:terminal_color_8 =  '#616675'
  let g:terminal_color_9 =  '#e0945e'
  let g:terminal_color_10 = '#252c40'
  let g:terminal_color_11 = '#313a54'
  let g:terminal_color_12 = '#7b8194'
  let g:terminal_color_13 = '#bac4e0'
  let g:terminal_color_14 = '#c9879d'
  let g:terminal_color_15 = '#ebf0ff'
endif
...
if filereadable(expand('~/.nightshell/nemo-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/nemo-dark'
  endif
endif
...
if exists('g:nemo_dark_CursorLineNr')
if g:nemo_dark_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:nemo_dark_LineNr')
if g:nemo_dark_LineNr == 'off'
