" nemo-light, a vim colourscheme by nightsense
"
...
" neovim colours
if has('nvim')
  let g:terminal_color_0 =  '#ebf0ff'
  let g:terminal_color_1 =  '#eb493a'
  let g:terminal_color_2 =  '#349e3d'
  let g:terminal_color_3 =  '#d4b935'
  let g:terminal_color_4 =  '#3f8abf'
  let g:terminal_color_5 =  '#9c69b5'
  let g:terminal_color_6 =  '#289e8b'
  let g:terminal_color_7 =  '#313a54'
  let g:terminal_color_8 =  '#7b8194'
  let g:terminal_color_9 =  '#e07426'
  let g:terminal_color_10 = '#bac4e0'
  let g:terminal_color_11 = '#9fa7bf'
  let g:terminal_color_12 = '#616675'
  let g:terminal_color_13 = '#252c40'
  let g:terminal_color_14 = '#c96587'
  let g:terminal_color_15 = '#161b2b'
endif
...
augroup NightsenseThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme nemo-light | endif'
augroup END
let colors_name = 'nemo-light'
...
if exists('g:nemo_light_CursorLineNr')
if g:nemo_light_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:nemo_light_LineNr')
if g:nemo_light_LineNr == 'off'
